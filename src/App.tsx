            ...
            <div className="max-w-xl mx-auto mb-12">
              <div className="flex items-center rounded-full bg-black/40 border border-white/20 px-2 py-1 backdrop-blur-lg">
                <input
                  ...
                  className="flex-1 bg-transparent text-sm md:text-base px-4 py-3 outline-none text-white placeholder-slate-400"
                />
                <button
                  onClick={handleJoinPilot}
                  className="bg-emerald-500 hover:bg-emerald-400 text-white px-6 md:px-8 py-3 rounded-full font-semibold transition-all duration-300 whitespace-nowrap"
                >
                  Join Waitlist
                </button>
              </div>
